...
import { type LogEntry, type Severity, severityColor } from "./consoleData";
...
export function ConsolePanel({ logs, setLogs }: { logs: LogEntry[]; setLogs: React.Dispatch<React.SetStateAction<LogEntry[]>> }) {
